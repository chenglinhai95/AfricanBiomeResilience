...
outpath = "E:/AfricaResearch/StabilityTrend/paper_fig1/"

map_afbs = raster("AFABSs.tif")
map_afbs_ar1mean = raster("AFABSs_ar1mean.tif")
map_afbs_ar1trend = raster("AFABSs_ar1trend.tif")
map_afbs_ar1trendsig = raster("AFABSs_ar1trend_sig.tif")
